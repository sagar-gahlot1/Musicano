<?php
	...
	$uquery=mysqli_query($conn1,"SELECT * FROM `art` WHERE arti_id='".$_SESSION['arti_id']."'");
...
<table id="chat_room" align="center">
	<tr>
	<th><h4>Hi, <a href="prof.php?arti_id=<?php echo $_SESSION['arti_id']; ?>"><?php echo $urow['artist_name']; ?></a>  - <a href="logout.php" onclick="return confirm_logout();">Logout</a></h4></th>
	</tr>
	<?php
