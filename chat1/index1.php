...
<div class="form-wrap">
		<div class="tabs">
			...
			<h3 class="login-tab"><a href="indo.php">Login</a></h3>
		</div><!--.tabs-->

		<div class="tabs-content">
			<div id="signup-tab-content" class="active">
				<form class="signup-form" action="register1.php" method="post">
					<input type="text" class="input" name="artist_name" autocomplete="off" placeholder="Artist's Name">
					...
					<input type="text" class="input" name="address" autocomplete="off" placeholder="Address" >
	  ...
	  <h2>Expert In:</h2></br>
	  <select name="expert_in" style="width:240px; height:35px;">
